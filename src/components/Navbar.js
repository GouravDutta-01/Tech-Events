  ...
  return (
    <nav className={`navbar sticky-top navbar-expand-lg bg-${props.mode === 'light'?'light':'dark'} navbar-${props.mode === 'light'?'light':'dark'}`}>
      <div className="container-fluid">
        ...
        <span className="fw-bold"><span style={{color: '#4285f4'}}>T</span><span style={{color: '#ea4335'}}>e</span><span style={{color: '#fbbc05'}}>c</span><span style={{color: '#34a853'}}>h</span>Events</span>
        </a>
        <button
